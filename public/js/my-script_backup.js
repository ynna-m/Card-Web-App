...
function initializeDeckPattern(){
    ...
    if(!curDeck){
                ...
                request.onsuccess = function(event) {
                    ...
                    query.onsuccess = function() {
                        ...
                        deckShowrequest.onsuccess = function(){
                            ...
                            console.log(deckShowrequest.result);
        ...
        request.onsuccess = function(event) {
            ...
            console.log("currentDeckinelseInitialize")
            console.log(curDeck);
            query.onsuccess = function(event){
                ...
                countRequest.onsuccess = function() {
                    ...
                    getDeckDB.onsuccess = function(data){
                        console.log(data.target.source.deckList)
...
function initializeSaveList(){
    ...
    console.log("initializesavelist")
    console.log(sidSaved);
    if(sidSaved){
    ...
    $("#linkFlipAll").click(function() {
        ...
        myCard.each(function(){
            if(!$(this).data("flip-model")){
                console.log($(this).data("flip-model"))
                $(this).flip();
                $(this).flip(true);
                flippedCards++;
            }            
    ...
    $("#btnSaveDraw").click(function(event){
        if(form.valid()){
            ...
            if(saveEditID>-1){
                ...
                console.log("if cache has nothing")
                cidSaved = [0];
                ctitle = [gettitle];
                ...
                console.log("here if cache has something");
    ...
    importSaves.click(function(){
        ...
        upload.onchange=function(inputfile){
            ...
            filereader.onload = function(file){
                ...
                console.log("importedSaveList");
                console.log(importedSaveList); // You can index every object
    ...
    $("#btnAppendSaveList").click(function(){
        ...
        if(!iidSave){
            ...
            for(let i = 0; i<idToIterate.length;i++){
                // console.log("imported save list for loop")
...
$(document).ready(function() {
    ...
    deckPattern = {
        value: null,
        process() {
            console.log(`The variable has changed to ${this.getDeckPattern}`);
            distributeCards();
            cardFlip();
            cardFlipAll();
            reShuffle();
